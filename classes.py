class Mission(object):
    ...
    def land_schuttle(self):
        while shuttle.distance != 0:
            msg = ("Type thrusters to break with Retroburning.\n"
                   "Type fall to continue falling.\n"
                   "Shuttle {dist} from surface, speed {speed}, fuel {fuel}").format(dist=shuttle.distance, speed=shuttle.speed, fuel=shuttle.fuel)
        ...
        if shuttle.distance == 0:
            ...
            if shuttle.landed_successfully == False:
               sys.exit()
                ...
                print("You pack up the rover with the help of the Eugene.\n"
